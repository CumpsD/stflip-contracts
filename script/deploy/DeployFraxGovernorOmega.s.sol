...
import { FraxGovernorOmega, ConstructorParams as FraxGovernorOmegaParams } from "@governance/src/FraxGovernorOmega.sol";
...
function deployFraxGovernorOmega(
    ...
    FraxGovernorOmegaParams memory _params = FraxGovernorOmegaParams({
        ...
        initialVotingPeriod: initialVotingPeriod,
        initialProposalThreshold: type(uint256).max,
        quorumNumeratorValue: quorumNumeratorValue,
        initialShortCircuitNumerator: initialShortCircuitNumerator
    });
