...
### Set Rebase
The ultimate purpose of this contract is to calculate a new rebase factor to adjust the supply of stFLIP. The final call sets the rebase factor of the stFLIP token
